...
\begin{document}
    ...
    Cabe destacar que, en la presente figura se muestra la existencia de cinco bandas no nulas, a pesar de que sólo pareciera haber tres. Esto se debe a la proximidad indexada de las subdiagonales más cercanas a la diagonal principal, cuyas distancias de acoplamiento en la vecindad inmediata se fusionan visualmente ante la resolución de la visualización global ($400 \times 400$). En contraste, las bandas más externas se presentan claramente separadas de la franja central debido al desplazamiento indexado constante requerido para transitar hacia las filas adyacentes dentro de la estructura unidimensional aplanada.
